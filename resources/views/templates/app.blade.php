...
<html lang="en">
  ...
  <body >
    ...
    <div class="page">
      <!-- Navbar -->
      <header class="navbar navbar-expand-md d-print-none" style="background-color: #00425A; background-image: linear-gradient(to bottom left, #E7B10A, #00425A );">
        <div class="container-xl">
          ...
          <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href="/">
              <img src="demo/static/upt_jatim.png" width="200" height="70" alt="Tabler">
            </a>
          </h1>
		  <ul class="navbar-nav">
			<li class="nav-item">
			  <a class="nav-link" href="/" >
				<span class="nav-link-icon d-md-none d-lg-inline-block" style="color: white;"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
			  ...
			  <div class="dropdown-menu">
				<div class="dropdown-menu-columns">
				  <div class="dropdown-menu-column">
					<a class="dropdown-item" href="/dt-barang">
					  Data Barang
					</a>
					<a class="dropdown-item" href="/sewa">
					  Data Sewa
					</a>
					...
					<a class="dropdown-item" href="/mesin">
						Data Pembuatan Mesin
					</a>
					<a class="dropdown-item" href="/lahan">
						Data Penyewa Lahan
					</a>
				  </div>
				  <div class="dropdown-menu-column">
					<a class="dropdown-item" href="perusahaan">
					  Data Perusahaan
					</a>
					...
					<a class="dropdown-item" href="/message1">
					  Pesan Customer
					</a>
				  </div>
				</div>
			...
			<li class="nav-item">
				<a style="color: white;" class="nav-link" href="/keranjang" >
				  <span style="color: white;"  class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/checkbox -->
		  ...
		  <div class="my-2 my-md-0 flex-grow-1 text-white flex-md-grow-0 order-first order-md-last">
					...
					@else
						{{-- @if ($count > 0)
							...
							<li class="nav-item">
								...
								<a class="nav-link" href="/keranjang"><i class="fa fa-shopping-cart" aria-hidden="true"></i><span class="badge text-bg-primary">{{$count}}</span></a>
							</li>
						@endif --}}
				<li class="nav-item dropdown">
    ...
    <!-- Libs JS -->
    <script src="tabler/dist/libs/apexcharts/dist/apexcharts.min.js?1684106062" defer></script>
    <script src="tabler/dist/libs/jsvectormap/dist/js/jsvectormap.min.js?1684106062" defer></script>
    <script src="tabler/dist/libs/jsvectormap/dist/maps/world.js?1684106062" defer></script>
    <script src="tabler/dist/libs/jsvectormap/dist/maps/world-merc.js?1684106062" defer></script>
